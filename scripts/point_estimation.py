...
pub_R = rospy.Publisher("/point_est/estimation", PointStamped)
pub_t = rospy.Publisher("/point_est/truth", PointStamped)
...
def wrench_callback(msg):
	...
	wrench = msg
	H[0,4] = wrench.wrench.force.z
	H[0,5] = -wrench.wrench.force.y
	H[1,3] = -wrench.wrench.force.z
	H[1,5] = wrench.wrench.force.x
	H[2,3] = wrench.wrench.force.y
	H[2,4] = -wrench.wrench.force.x
